...
void manager::operMenu() { 
	cout << "\t\t|---欢迎机房管理员：" << this->m_name << " 登录---|" << endl;
	cout << "\t\t ---------------------------------\n";
	cout << "\t\t|                                |\n";
	cout << "\t\t|          1.添加账号(学生/老师）|\n";
	cout << "\t\t|                                |\n";
...
void printstudent(student& s) {
	cout << "学号：" << s.m_studentId << "\t姓名：" << s.m_name << "\t密码：" << s.m_pwd << endl;
}
void printteacher(teacher& t) {
	cout << "职工号：" << t.m_teacherId << "\t教师：" << t.m_name << "\t密码：" << t.m_pwd << endl;
}
...
void manager::modifyComputer() {
	...
	cout << "---请选择要修改的机房编号：" << endl;
	int roomId;
	cin >> roomId;

	cout << "---请输入新的机房最大容量：" << endl;
	int newMaxNum;
	cin >> newMaxNum;
